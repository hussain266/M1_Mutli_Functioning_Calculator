...
void cube();
void squareroot();
void Percentage_of_Profit_or_Loss();
int main(){
    ...
    printf("Enter 11 for Percentage of Profit or loss\n");
...
void Percentage_of_Profit_or_Loss(){
    float b,c,Proift_Percentage,loss_Percentage;
    printf("Enter the amount you have earned");
    scanf("%f",&b);
    printf("Enter the Investment u have made");
    scanf("%f",&c);
    if(c<b){
        Proift_Percentage=((b-c)/c)*100;
        printf("Your Proift_Percentage=%.2f",Proift_Percentage);
    }
    else{
        loss_Percentage=((c-b)/c)*100;
        printf("Your loss_Percentage=%.2f",loss_Percentage);
    }
}
